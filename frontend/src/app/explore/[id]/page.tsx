              ...
              {[
                {
                  ...
                  desc: "Initial architecture and funding sequence.",
                },
                {
                  year: failure.year - 1,
                  title: "MARKET FRICTION",
                  desc: "Detected anomalies in market penetration.",
                },
                {
                  year: failure.year,
                  title: "TERMINAL SHUTDOWN",
                  active: true,
                  desc: "System collapse and asset liquidation.",
                },
              ].map((item, i) => (
                <div
                  key={i}
