      ...
      <section className="hero-shell relative w-full py-24 lg:py-40 flex flex-col items-center text-center px-4 overflow-hidden">
        ...
        <div className="container mx-auto max-w-5xl relative hero-content">
          ...
          <div className="hero-actions flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Button
              size="lg"
              className="px-10 h-14 text-lg rounded-full glow-primary glow-cta hover-lift hover-scale"
              asChild
            >
              <Link href="/explore">
            ...
            <Button
              size="lg"
              variant="outline"
              className="px-10 h-14 text-lg rounded-full glass glow-cta-subtle hover-lift hover-scale"
              asChild
            >
              <Link href="/analyzer">{t("analyzerButton")}</Link>
            </Button>
          </div>
