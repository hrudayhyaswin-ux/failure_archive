        ...
        <div className="flex min-w-0 flex-1 items-center gap-6 lg:gap-12">
          ...
          >
            ...
            <div className="flex min-w-0 flex-col">
              <span className="truncate text-xs font-black uppercase tracking-[0.3em] text-foreground">
                {t("title")}
              </span>
        ...
        <div className="hidden items-center gap-3 md:flex">
          <div className="relative flex items-center">
            ...
            >
              ...
              <option value="te" className="bg-background text-foreground">
                తెలుగు
              </option>
              <option value="hi" className="bg-background text-foreground">
                हिन्दी
              </option>
              <option value="ta" className="bg-background text-foreground">
                தமிழ்
              </option>
              <option value="kn" className="bg-background text-foreground">
                ಕನ್ನಡ
              </option>
              <option value="ml" className="bg-background text-foreground">
                മലയാളം
              </option>
            </select>
            <div className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-primary text-[8px]">
              ▼
            </div>
          </div>
          <Button
            variant="ghost"
            size="sm"
            className="rounded-full px-5 text-[10px] font-black uppercase tracking-widest transition-all duration-300 ease-out hover:-translate-y-0.5 hover:bg-primary/10 hover:text-primary"
            asChild
          >
          ...
          <Button
            size="sm"
            className="h-11 rounded-full border-none bg-primary px-7 text-[10px] font-black uppercase tracking-widest text-primary-foreground shadow-lg shadow-primary/25 transition-all duration-300 ease-out hover:-translate-y-0.5 hover:bg-primary/90 hover:shadow-primary/40"
            asChild
          >
          ...
          <div className="min-h-0">
            <div className="mt-2 flex flex-col gap-2 border-t border-white/10 pt-3">
              ...
              <div className="grid grid-cols-2 gap-3 pt-2">
                ...
                <Button
                  size="sm"
                  className="rounded-full border-none bg-primary text-[10px] font-black uppercase tracking-widest text-primary-foreground shadow-lg shadow-primary/25 hover:bg-primary/90"
                  asChild
                >
                  <Link href="/login" onClick={() => setIsMobileOpen(false)}>
                    {t("initialize")}
